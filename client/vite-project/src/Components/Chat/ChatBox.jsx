  ...
  return (
      ...
      <Stack gap={4} className= "chat-box">
        ...
        <Stack direction='horizontal' gap={3} className='chat-input flex-grow-0'>
            <InputEmoji value= {textMessage} onChange={setTextMeassage} fontFamily='nunito' borderColor='rgba(72, 112, 223, 0.2)'/>
            <button className='send-btn' onClick={()=>{sendTextMessage(textMessage, user, currentChat._id, setTextMeassage)}}>
